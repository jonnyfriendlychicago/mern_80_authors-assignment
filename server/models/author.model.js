// ! findReplace all "Author" with "YourNewAuthorityName" or whatever your new thing is 
...
const rockOutNewCollection = new mongoose.Schema (
    {
        ...
        authorName: {
            ...
            , minlength: [3, "authorName must be 3 characters or more"]
            // , default: "N/A"
        }
        // , numberField: {
        //     type: Number
...
// ! update name of collection below, specific to what you want to create here.  change "author" in next line to "studauthors" or "users" or "widgets"
module.exports= mongoose.model('author', rockOutNewCollection); 
